...
class IPhoneMenuScreen extends StatelessWidget {
  ...
  final List<ItemMainMenu> mainMenuIphoneScreen = [
    ItemMainMenu(
        ...
        titleItem: StringsApp.PRESTAR,
        route: NavigationRoutes.IPHONE_SCREEN_BOARDGAME_ROUTE,
        access: 1),
    ItemMainMenu(
        iconItem: "assets/icons/my_games.png",
        titleItem: StringsApp.DEVOLVER,
        route: NavigationRoutes.IPHONE_SCREEN_DROP_BOARDGAME_ROUTE,
        access: 1)
  ];
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                      "${StringsApp.USER} ${proxyMemberProvider.getProxyMember().name}"),
                ],
              ),
            ),
            Flexible(
