...
class NavigationRoutes {
  ...
  static const String BOARDGAME_DETAIL_ROUTE =
      "$LENT_SCREEN_ROUTE/$_BOARDGAME_DETAIL_PATH";
  static const String OWNGAMES_SCREEN_ROUTE = "/owngames";
  static const String IPHONE_SCREEN_ROUTE = "/iphone";
  static const String IPHONE_SCREEN_BOARDGAME_ROUTE =
      "$IPHONE_SCREEN_MENU_ROUTE/$_IPHONE_BOARDGAME_PATH";
  static const String IPHONE_SCREEN_DROP_BOARDGAME_ROUTE =
      "$IPHONE_SCREEN_MENU_ROUTE/$_IPHONE_DROP_BOARDGAME_PATH";
  static const String IPHONE_SCREEN_MENU_ROUTE =
      "$IPHONE_SCREEN_ROUTE/$_IPHONE_MENU_PATH";
  static const String IPHONE_SCREEN_BOARDGAME_DETAIL_ROUTE =
      "$IPHONE_SCREEN_BOARDGAME_ROUTE/$_IPHONE_BOARDGAME_DETAIL_PATH";
  ...
  static const String _IPHONE_BOARDGAME_DETAIL_PATH =
      "iphone_boardgame_detail_path";
  static const String _IPHONE_DROP_BOARDGAME_PATH =
      "iphone_drop_boardgame_path";
}
